...
function submitItem() {
    ...
    if(!validateItem()) {
    	...
    	$(".itemBox #boardCoarseV").each(function(index, element){
    		boardCourse.push($(this).val());
    	});
    	$("#boardCourse").val(boardCourse.toString());
    	alert("현재 코스로 적용 되었습니다.");
    	alert(boardCourse.toString());
    }
}

/** 아이템 체크 */
function validateItem() {
    var items = $("input[type='text'][name='boardCoarseV']");
...
function createBox() {
    var contents = "<div class='itemBox'>"
                 ...
                 + "<input type='text' class='col-9' id ='boardCoarseV' name='boardCoarseV'>"
                 + "</div>"
                 + "</div>";
    return contents;
}
...
<body>
	...
	<div>
		...
		<form action="saveBoard.do" method='post' enctype="multipart/form-data">
			...
			boardWriter = (String)session.getAttribute("${usrNick.getUsrNick()"); %>
			
			<div class="row" style="background-color: white;">
				<div class="col-1"></div>
				<input type="hidden" name="boardWriter" value="<%=boardWriter %>">
				<mark class="col-1"><%=boardWriter %></mark>
			...
			<div class="row">
				...
				<!-- 키워드 팝업 결과값 노출 -->
				<input type="text" class="col-7" name="boardKeyword" id="boardKeyword" value="선택된 키워드가 없습니다.">
			...
			<div class="row" id="freeBoard">
				...
				<div class="col-10">
					<textarea class="w-100 h-100 contentBox" name="boardContent1" id="boardContent1" placeholder="자유롭게 글을 남겨 주세요" value=""></textarea>
				</div>
			...
			<div class="row" id="courseBoard">
				...
				<div class="col-6">
					<textarea class="w-100 p-12 h-100 contentBox" name="boardContent1" id="boardContent1" placeholder="선택하신 코스에 대해 얘기 해주세요." value=""></textarea>
				</div>
				<div class="col-4">
					<div class="row">
					...
					<div class="row"><input class="col-10" type="text" name="boardCourse" id="boardCourse" placeholder="코스를 설정해주세요" value=""></div>
			...
			<div class="row" id="regionBoard">
				...
				<div class="col-6" >
					<textarea class="w-100 p-12 h-100 contentBox" name="boardContent1" id="boardContent1" placeholder="관광지에 대해 설명해 주세요" value=""></textarea>
				</div>
				<div class="col-4">
					<div style="margin:auto" id="usrFotoZone">
						<div class="row">
							<input type="text" class="col-12" name="boardRegion" id="boardRegionSelect" placeholder="선택된 관광지가 없습니다." value="">
						</div>
						<div class="row"><br/></div>
